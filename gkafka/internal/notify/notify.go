// Package notify is temporarily kept here until Geist has made its version importable.
package notify
...
func (n *Notifier) Notify(level int, message string, args ...any) {
	...
	// For now, don't send debug events to notify channel
	if level > entity.NotifyLevelDebug {
